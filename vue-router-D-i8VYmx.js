...
let RouterView, createWebHistory, createRouter, useRoute;
let __tla = Promise.all([
    ...
    createWebHistory = function(base) {
    ...
    useRoute = function(_name) {
        return inject(routeLocationKey);
    };
});
export { RouterView as R, createWebHistory as a, createRouter as c, useRoute as u, __tla };
